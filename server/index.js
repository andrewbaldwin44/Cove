...
const { handleSockets } = require("./handlers/socketHandlers");

const { handleYoutubeSearch } = require("./handlers/youtubeApiHandlers");
...
app
  .use(function (req, res, next) {
    res.header("Access-Control-Allow-Origin", process.env.WHITELIST_ORIGINS);
    res.header(
